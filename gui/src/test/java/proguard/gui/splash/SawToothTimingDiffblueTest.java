...
class SawToothTimingDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link SawToothTiming#SawToothTiming(long, long)} with period is one and phase is one.</li>
   ...
   */
  @Test
  @DisplayName("Test getTiming(long); given SawToothTiming(long, long) with period is one and phase is one; then return zero")
  @Tag("MaintainedByDiffblue")
