...
class ConfigurationLoggingInstructionSequenceReplacerDiffblueTest {
  /**
   * Test {@link ConfigurationLoggingInstructionSequenceReplacer#matchedArgument(Clazz, Method, CodeAttribute, int, int)} with {@code clazz}, {@code method}, {@code codeAttribute}, {@code offset}, {@code argument}.
   * <p>
   * Method under test: {@link ConfigurationLoggingInstructionSequenceReplacer#matchedArgument(Clazz, Method, CodeAttribute, int, int)}
   */
  @Test
  @DisplayName("Test matchedArgument(Clazz, Method, CodeAttribute, int, int) with 'clazz', 'method', 'codeAttribute', 'offset', 'argument'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "int proguard.configuration.ConfigurationLoggingInstructionSequenceReplacer.matchedArgument(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, int, int)"})
   ...
   */
  @Test
  @DisplayName("Test matchedArgument(Clazz, Method, CodeAttribute, int, int) with 'clazz', 'method', 'codeAttribute', 'offset', 'argument'; then return two")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "int proguard.configuration.ConfigurationLoggingInstructionSequenceReplacer.matchedArgument(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, int, int)"})
   ...
   */
  @Test
  @DisplayName("Test matchedArgument(Clazz, Method, CodeAttribute, int, int) with 'clazz', 'method', 'codeAttribute', 'offset', 'argument'; then return zero")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "int proguard.configuration.ConfigurationLoggingInstructionSequenceReplacer.matchedArgument(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, int, int)"})
   ...
   */
  @Test
  @DisplayName("Test matchedArgument(Clazz, Method, CodeAttribute, int, int) with 'clazz', 'method', 'codeAttribute', 'offset', 'argument'; when one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "int proguard.configuration.ConfigurationLoggingInstructionSequenceReplacer.matchedArgument(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, int, int)"})
