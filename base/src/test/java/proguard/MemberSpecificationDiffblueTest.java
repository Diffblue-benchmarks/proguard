...
class MemberSpecificationDiffblueTest {
  ...
  @MethodsUnderTest({"void proguard.MemberSpecification.<init>()",
      "void proguard.MemberSpecification.<init>(int, int, java.lang.String, java.lang.String, java.lang.String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean proguard.MemberSpecification.equals(java.lang.Object)",
      "int proguard.MemberSpecification.hashCode()"})
