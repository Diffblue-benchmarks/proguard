...
class ReverseDependencyCalculatorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link ReverseDependencyCalculator#reverseDependencyStore()}
   */
  @Test
  @DisplayName("Test reverseDependencyStore(); then calls classesAccept(ClassVisitor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "proguard.optimize.ReverseDependencyStore proguard.optimize.ReverseDependencyCalculator.reverseDependencyStore()"})
