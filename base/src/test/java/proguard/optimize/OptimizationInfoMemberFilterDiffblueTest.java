...
class OptimizationInfoMemberFilterDiffblueTest {
  ...
  @MethodsUnderTest({"void OptimizationInfoMemberFilter.visitProgramField(ProgramClass, ProgramField)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void OptimizationInfoMemberFilter.visitProgramMethod(ProgramClass, ProgramMethod)"})
