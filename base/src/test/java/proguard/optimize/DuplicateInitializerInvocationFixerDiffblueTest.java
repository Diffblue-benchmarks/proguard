...
class DuplicateInitializerInvocationFixerDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.optimize.DuplicateInitializerInvocationFixer.visitAnyMethodrefConstant(proguard.classfile.Clazz, proguard.classfile.constant.AnyMethodrefConstant)"})
