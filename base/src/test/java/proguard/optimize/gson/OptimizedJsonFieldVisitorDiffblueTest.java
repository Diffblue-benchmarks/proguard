...
class OptimizedJsonFieldVisitorDiffblueTest {
   ...
   * <ul>
   *   <li>When {@link NamedClass#NamedClass(String)} with {@code Member Name}.</li>
   *   <li>Then calls {@link ClassVisitor#visitProgramClass(ProgramClass)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link OptimizedJsonFieldVisitor#visitProgramClass(ProgramClass)}
   */
  @Test
  @DisplayName("Test visitProgramClass(ProgramClass); when NamedClass(String) with 'Member Name'; then calls visitProgramClass(ProgramClass)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.optimize.gson.OptimizedJsonFieldVisitor.visitProgramClass(proguard.classfile.ProgramClass)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link OptimizedJsonFieldVisitor#visitProgramField(ProgramClass, ProgramField)}
   */
  @Test
  @DisplayName("Test visitProgramField(ProgramClass, ProgramField); then calls visitProgramField(ProgramClass, ProgramField)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.optimize.gson.OptimizedJsonFieldVisitor.visitProgramField(proguard.classfile.ProgramClass, proguard.classfile.ProgramField)"})
