...
class GsonInstrumentationAdderDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.optimize.gson.GsonInstrumentationAdder.visitAnyInstruction(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, int, proguard.classfile.instruction.Instruction)"})
