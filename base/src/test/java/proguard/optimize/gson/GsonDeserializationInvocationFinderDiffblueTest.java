...
class GsonDeserializationInvocationFinderDiffblueTest {
  /**
   * Test {@link GsonDeserializationInvocationFinder#visitAnyInstruction(Clazz, Method, CodeAttribute, int, Instruction)}.
   * <ul>
   ...
   * </ul>
   * <p>
   * Method under test: {@link GsonDeserializationInvocationFinder#visitAnyInstruction(Clazz, Method, CodeAttribute, int, Instruction)}
   */
  @Test
  ...
  @MethodsUnderTest({
      "void proguard.optimize.gson.GsonDeserializationInvocationFinder.visitAnyInstruction(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, int, proguard.classfile.instruction.Instruction)"})
