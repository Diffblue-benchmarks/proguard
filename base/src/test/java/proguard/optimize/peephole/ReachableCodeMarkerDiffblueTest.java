...
class ReachableCodeMarkerDiffblueTest {
  ...
  @MethodsUnderTest({"boolean proguard.optimize.peephole.ReachableCodeMarker.isReachable(int)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean proguard.optimize.peephole.ReachableCodeMarker.isReachable(int, int)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void proguard.optimize.peephole.ReachableCodeMarker.<init>()"})
