...
class WrapperClassUseSimplifierDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.optimize.peephole.WrapperClassUseSimplifier.visitMethodrefConstant(proguard.classfile.Clazz, proguard.classfile.constant.MethodrefConstant)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.optimize.peephole.WrapperClassUseSimplifier.visitClassConstant(proguard.classfile.Clazz, proguard.classfile.constant.ClassConstant)"})
