...
class RetargetedInnerClassAttributeRemoverDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.optimize.peephole.RetargetedInnerClassAttributeRemover.visitInnerClassesInfo(proguard.classfile.Clazz, proguard.classfile.attribute.InnerClassesInfo)"})
