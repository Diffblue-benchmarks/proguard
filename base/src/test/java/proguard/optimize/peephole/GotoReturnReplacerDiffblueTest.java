...
class GotoReturnReplacerDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.optimize.peephole.GotoReturnReplacer.visitBranchInstruction(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, int, proguard.classfile.instruction.BranchInstruction)"})
