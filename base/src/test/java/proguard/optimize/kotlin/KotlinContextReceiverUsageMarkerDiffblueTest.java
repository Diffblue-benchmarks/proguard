...
class KotlinContextReceiverUsageMarkerDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.optimize.kotlin.KotlinContextReceiverUsageMarker.visitKotlinClassMetadata(proguard.classfile.Clazz, proguard.classfile.kotlin.KotlinClassKindMetadata)"})
