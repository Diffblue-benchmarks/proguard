...
class SimpleEnumUseSimplifierDiffblueTest {
  ...
  @MethodsUnderTest({"void SimpleEnumUseSimplifier.visitCodeAttribute(Clazz, Method, CodeAttribute)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void SimpleEnumUseSimplifier.visitParameter(Clazz, Member, int, int, int, int, String, Clazz)"})
