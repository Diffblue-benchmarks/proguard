...
class SideEffectMethodMarkerDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.optimize.info.SideEffectMethodMarker.visitProgramMethod(proguard.classfile.ProgramClass, proguard.classfile.ProgramMethod)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.optimize.info.SideEffectMethodMarker.visitAnyInstruction(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, int, proguard.classfile.instruction.Instruction)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean proguard.optimize.info.SideEffectMethodMarker.hasSideEffects(proguard.classfile.Method)"})
