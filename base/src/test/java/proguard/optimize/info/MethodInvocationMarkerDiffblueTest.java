...
class MethodInvocationMarkerDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.optimize.info.MethodInvocationMarker.visitStringConstant(proguard.classfile.Clazz, proguard.classfile.constant.StringConstant)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.optimize.info.MethodInvocationMarker.visitAnyMethodrefConstant(proguard.classfile.Clazz, proguard.classfile.constant.AnyMethodrefConstant)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.optimize.info.MethodInvocationMarker.visitProgramMethod(proguard.classfile.ProgramClass, proguard.classfile.ProgramMethod)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"int proguard.optimize.info.MethodInvocationMarker.getInvocationCount(proguard.classfile.Method)"})
