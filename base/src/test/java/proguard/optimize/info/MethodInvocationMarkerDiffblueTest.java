...
class MethodInvocationMarkerDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test visitAnyMethodrefConstant(Clazz, AnyMethodrefConstant); given LibraryClass(); then calls addSubClass(Clazz)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void MethodInvocationMarker.visitAnyMethodrefConstant(Clazz, AnyMethodrefConstant)"
  })
  void testVisitAnyMethodrefConstant_givenLibraryClass_thenCallsAddSubClass() {
    // Arrange
    MethodInvocationMarker methodInvocationMarker = new MethodInvocationMarker();
    LibraryClass clazz = new LibraryClass();
    ...
    // Act
    methodInvocationMarker.visitAnyMethodrefConstant(
