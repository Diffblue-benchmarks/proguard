...
class ExceptionInstructionCheckerDiffblueTest {
  ...
  @MethodsUnderTest({"boolean ExceptionInstructionChecker.mayThrowExceptions(Clazz, Method, CodeAttribute)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean ExceptionInstructionChecker.mayThrowExceptions(Clazz, Method, CodeAttribute, int)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean ExceptionInstructionChecker.mayThrowExceptions(Clazz, Method, CodeAttribute, int, int)"})
