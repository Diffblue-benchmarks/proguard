...
class AccessMethodMarkerDiffblueTest {
  ...
  void testVisitConstantInstruction2() {
    ...
    doNothing().when(classConstant).accept(Mockito.<Clazz>any(), Mockito.<ConstantVisitor>any());
    ProgramClass clazz =
        new ProgramClass(1, 3, new Constant[] {classConstant, new MethodHandleConstant()}, 1, 1, 1);
    LibraryMethod method = new LibraryMethod(1, "Name", "Descriptor");
    CodeAttribute codeAttribute = new CodeAttribute(1);
  ...
  void testVisitConstantInstruction3() {
    ...
    doNothing().when(classConstant).accept(Mockito.<Clazz>any(), Mockito.<ConstantVisitor>any());
    ProgramClass clazz =
        new ProgramClass(1, 3, new Constant[] {classConstant, new MethodrefConstant()}, 1, 1, 1);
    LibraryMethod method = new LibraryMethod(1, "Name", "Descriptor");
    CodeAttribute codeAttribute = new CodeAttribute(1);
  ...
  void testVisitStringConstant_thenCallsSetAccessesPackageCode() {
    ...
    LibraryField libraryField = new LibraryField(0, "Name", "Descriptor");
    stringConstant.referencedMember = libraryField;
  ...
  void testVisitStringConstant_thenCallsSetAccessesProtectedCode() {
    ...
    StringConstant stringConstant = new StringConstant(1, new ResourceFile("foo.txt", 3L));
    stringConstant.referencedClass = mock(LibraryClass.class);
    LibraryField libraryField = new LibraryField(4, "Name", "Descriptor");
    stringConstant.referencedMember = libraryField;
  ...
  @Test
  @DisplayName(
      "Test visitMethodHandleConstant(Clazz, MethodHandleConstant); then calls accept(Clazz, ConstantVisitor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AccessMethodMarker.visitMethodHandleConstant(Clazz, MethodHandleConstant)"
  })
  void testVisitMethodHandleConstant_thenCallsAccept() {
    // Arrange
    AccessMethodMarker accessMethodMarker = new AccessMethodMarker();
  ...
  void testVisitAnyRefConstant_whenArrayOfConstantWithLongConstantWithValueIsFortyTwo() {
    // Arrange
    AccessMethodMarker accessMethodMarker = new AccessMethodMarker();
    Constant[] constantPool = new Constant[] {new LongConstant(42L)};
    ProgramClass clazz = new ProgramClass(1, 3, constantPool, 1, 1, 1);
  ...
  void testVisitAnyMember_thenCallsSetAccessesPackageCode() {
    ...
    accessMethodMarker.visitConstantInstruction(
        clazz, method, codeAttribute, 2, new ConstantInstruction((byte) 'A', 1));
    LibraryClass clazz2 = new LibraryClass();
    LibraryField member = new LibraryField(0, "Name", "Descriptor");
  ...
  void testVisitAnyMember_thenCallsSetAccessesPrivateCode() {
    ...
    accessMethodMarker.visitConstantInstruction(
        clazz, method, codeAttribute, 2, new ConstantInstruction((byte) 'A', 1));
    LibraryClass clazz2 = new LibraryClass();
    LibraryField member = new LibraryField(2, "Name", "Descriptor");
  ...
  void testVisitAnyMember_thenCallsSetAccessesProtectedCode() {
    ...
    accessMethodMarker.visitConstantInstruction(
        clazz, method, codeAttribute, 2, new ConstantInstruction((byte) 'A', 1));
    LibraryClass clazz2 = new LibraryClass();
    LibraryField member = new LibraryField(4, "Name", "Descriptor");
