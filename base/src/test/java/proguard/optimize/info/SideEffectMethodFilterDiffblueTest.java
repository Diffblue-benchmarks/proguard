...
class SideEffectMethodFilterDiffblueTest {
  ...
  void testVisitProgramMethod_thenCallsHasSideEffects() {
    // Arrange
    SideEffectMethodFilter sideEffectMethodFilter =
        new SideEffectMethodFilter(mock(MemberVisitor.class));
    ProgramClass programClass = new ProgramClass();
  ...
  @Test
  @DisplayName(
      "Test visitLibraryMethod(LibraryClass, LibraryMethod); then calls accept(Clazz, MemberVisitor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   */
  @Test
  @DisplayName("Test visitLibraryMethod(LibraryClass, LibraryMethod); then calls hasSideEffects()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SideEffectMethodFilter.visitLibraryMethod(LibraryClass, LibraryMethod)"})
  void testVisitLibraryMethod_thenCallsHasSideEffects() {
    // Arrange
    SideEffectMethodFilter sideEffectMethodFilter =
        new SideEffectMethodFilter(mock(MemberVisitor.class));
    LibraryClass libraryClass = new LibraryClass();
