...
class KotlinMetadataVerifierDiffblueTest {
  ...
  @MethodsUnderTest({"void proguard.util.kotlin.asserter.KotlinMetadataVerifier.<init>(proguard.Configuration)"})
  void testNewKotlinMetadataVerifier() throws MalformedURLException {
    ...
    // Act and Assert
    assertEquals("proguard.util.kotlin.asserter.KotlinMetadataVerifier",
