...
class ExtraDataEntryReaderDiffblueTest {
  ...
  @MethodsUnderTest({"void proguard.io.ExtraDataEntryReader.<init>(java.lang.String, proguard.io.DataEntryReader)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.io.ExtraDataEntryReader.<init>(java.lang.String, proguard.io.DataEntryReader, proguard.io.DataEntryReader)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void proguard.io.ExtraDataEntryReader.read(proguard.io.DataEntry)"})
