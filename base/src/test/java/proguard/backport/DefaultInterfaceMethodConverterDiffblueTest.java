...
class DefaultInterfaceMethodConverterDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.backport.DefaultInterfaceMethodConverter.visitProgramClass(proguard.classfile.ProgramClass)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.backport.DefaultInterfaceMethodConverter.visitCodeAttribute(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute)"})
