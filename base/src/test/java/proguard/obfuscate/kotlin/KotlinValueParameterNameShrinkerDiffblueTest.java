...
class KotlinValueParameterNameShrinkerDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then calls {@link KotlinValueParameterMetadata#accept(Clazz, KotlinMetadata,
  ...
  @Test
  @DisplayName(
      "Test visitAnyFunction(Clazz, KotlinMetadata, KotlinFunctionMetadata); then calls accept(Clazz, KotlinMetadata, KotlinFunctionMetadata, KotlinValueParameterVisitor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void KotlinValueParameterNameShrinker.visitAnyFunction(Clazz, KotlinMetadata, KotlinFunctionMetadata)"
  })
  void testVisitAnyFunction_thenCallsAccept() {
    // Arrange
    KotlinValueParameterNameShrinker kotlinValueParameterNameShrinker =
        new KotlinValueParameterNameShrinker();
    LibraryClass clazz = new LibraryClass();
   ...
   *
   * <ul>
   *   <li>Then calls {@link KotlinFunctionMetadata#valueParametersAccept(Clazz, KotlinMetadata,
  ...
  @Test
  @DisplayName(
      "Test visitAnyFunction(Clazz, KotlinMetadata, KotlinFunctionMetadata); then calls valueParametersAccept(Clazz, KotlinMetadata, KotlinValueParameterVisitor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void KotlinValueParameterNameShrinker.visitAnyFunction(Clazz, KotlinMetadata, KotlinFunctionMetadata)"
  })
  void testVisitAnyFunction_thenCallsValueParametersAccept() {
    // Arrange
    KotlinValueParameterNameShrinker kotlinValueParameterNameShrinker =
        new KotlinValueParameterNameShrinker();
    LibraryClass clazz = new LibraryClass();
