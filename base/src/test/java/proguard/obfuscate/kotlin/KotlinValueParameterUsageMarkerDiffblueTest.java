...
class KotlinValueParameterUsageMarkerDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.obfuscate.kotlin.KotlinValueParameterUsageMarker.visitKotlinDeclarationContainerMetadata(proguard.classfile.Clazz, proguard.classfile.kotlin.KotlinDeclarationContainerMetadata)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.obfuscate.kotlin.KotlinValueParameterUsageMarker.visitKotlinClassMetadata(proguard.classfile.Clazz, proguard.classfile.kotlin.KotlinClassKindMetadata)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.obfuscate.kotlin.KotlinValueParameterUsageMarker.visitKotlinSyntheticClassMetadata(proguard.classfile.Clazz, proguard.classfile.kotlin.KotlinSyntheticClassKindMetadata)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.obfuscate.kotlin.KotlinValueParameterUsageMarker.visitConstructor(proguard.classfile.Clazz, proguard.classfile.kotlin.KotlinClassKindMetadata, proguard.classfile.kotlin.KotlinConstructorMetadata)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.obfuscate.kotlin.KotlinValueParameterUsageMarker.visitAnyFunction(proguard.classfile.Clazz, proguard.classfile.kotlin.KotlinMetadata, proguard.classfile.kotlin.KotlinFunctionMetadata)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "boolean proguard.obfuscate.kotlin.KotlinValueParameterUsageMarker.isUsed(proguard.util.Processable)"})
