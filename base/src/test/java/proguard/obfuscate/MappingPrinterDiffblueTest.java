...
class MappingPrinterDiffblueTest {
  ...
  @MethodsUnderTest({"void proguard.obfuscate.MappingPrinter.visitProgramClass(proguard.classfile.ProgramClass)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.obfuscate.MappingPrinter.visitLineNumberTableAttribute(proguard.classfile.Clazz, proguard.classfile.Method, proguard.classfile.attribute.CodeAttribute, proguard.classfile.attribute.LineNumberTableAttribute)"})
