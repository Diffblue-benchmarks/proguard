...
class RenamedFlagSetterDiffblueTest {
  ...
  @MethodsUnderTest({"void proguard.obfuscate.RenamedFlagSetter.visitProgramClass(proguard.classfile.ProgramClass)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.obfuscate.RenamedFlagSetter.visitProgramMember(proguard.classfile.ProgramClass, proguard.classfile.ProgramMember)"})
