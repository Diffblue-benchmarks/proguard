...
class AttributeShrinkerDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.obfuscate.AttributeShrinker.visitRecordAttribute(proguard.classfile.Clazz, proguard.classfile.attribute.RecordAttribute)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.obfuscate.AttributeShrinker.visitRecordComponentInfo(proguard.classfile.Clazz, proguard.classfile.attribute.RecordComponentInfo)"})
