...
class ObfuscationPreparationDiffblueTest {
  ...
  @MethodsUnderTest({"void proguard.obfuscate.ObfuscationPreparation.<init>(proguard.Configuration)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void proguard.obfuscate.ObfuscationPreparation.execute(proguard.AppView)"})
