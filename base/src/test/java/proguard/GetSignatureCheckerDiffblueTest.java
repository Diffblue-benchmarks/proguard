...
class GetSignatureCheckerDiffblueTest {
  ...
  void testVisitMethodrefConstant_givenClassName() {
    // Arrange
    GetSignatureChecker getSignatureChecker =
        new GetSignatureChecker(new WarningPrinter(new PrintWriter(new StringWriter())));
  ...
  @Test
  @DisplayName(
      "Test visitMethodrefConstant(Clazz, MethodrefConstant); given 'getType'; then calls getName()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void GetSignatureChecker.visitMethodrefConstant(Clazz, MethodrefConstant)"})
