...
class ShrinkerDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test execute(AppView); given Configuration (default constructor) keep is 'null'; then throw IOException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Shrinker.execute(AppView)"})
  void testExecute_givenConfigurationKeepIsNull_thenThrowIOException() throws IOException {
    // Arrange
    Configuration configuration = new Configuration();
    configuration.adaptClassStrings = new ArrayList<>();
    configuration.adaptResourceFileContents = new ArrayList<>();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Shrinker.execute(AppView)"})
  void testExecute_givenConfigurationKeepIsNull_thenThrowIOException2() throws IOException {
    // Arrange
    Configuration configuration = new Configuration();
    configuration.adaptClassStrings = new ArrayList<>();
    configuration.adaptResourceFileContents = new ArrayList<>();
  ...
  @Test
  @DisplayName(
      "Test execute(AppView); given Configuration (default constructor) printUsage is 'null'; then throw IOException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Shrinker.execute(AppView)"})
  void testExecute_givenConfigurationPrintUsageIsNull_thenThrowIOException() throws IOException {
    // Arrange
    Configuration configuration = new Configuration();
    configuration.adaptClassStrings = new ArrayList<>();
    configuration.adaptResourceFileContents = new ArrayList<>();
