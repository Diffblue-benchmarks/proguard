...
class UsagePrinterDiffblueTest {
  ...
  @MethodsUnderTest({"void proguard.shrink.UsagePrinter.visitProgramClass(proguard.classfile.ProgramClass)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.shrink.UsagePrinter.visitProgramField(proguard.classfile.ProgramClass, proguard.classfile.ProgramField)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.shrink.UsagePrinter.visitProgramMethod(proguard.classfile.ProgramClass, proguard.classfile.ProgramMethod)"})
