...
class RecordComponentUsageMarkerDiffblueTest {
  ...
  @MethodsUnderTest({
      "void proguard.shrink.RecordComponentUsageMarker.visitRecordComponentInfo(proguard.classfile.Clazz, proguard.classfile.attribute.RecordComponentInfo)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.shrink.RecordComponentUsageMarker.visitProgramField(proguard.classfile.ProgramClass, proguard.classfile.ProgramField)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void proguard.shrink.RecordComponentUsageMarker.visitUtf8Constant(proguard.classfile.Clazz, proguard.classfile.constant.Utf8Constant)"})
