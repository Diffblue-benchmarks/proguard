...
class KotlinModuleUsageMarkerDiffblueTest {
   ...
   * <ul>
   *   <li>Then calls {@link SimpleUsageMarker#isUsed(Processable)}.</li>
   * </ul>
   * <p>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void KotlinModuleUsageMarker.visitKotlinModulePackage(KotlinModule, KotlinModulePackage)"})
