...
class PassRunnerDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link Exception#Exception(String)} with {@code Pass {} completed in {}}.
  ...
  @Test
  @DisplayName(
      "Test run(Pass, AppView); given Exception(String) with 'Pass {} completed in {}'; then throw Exception")
   ...
   *
   * <ul>
   *   <li>When {@link Pass} {@link Pass#execute(AppView)} does nothing.
   * </ul>
   *
   * <p>Method under test: {@link PassRunner#run(Pass, AppView)}
   */
