...
class KeepClassSpecificationVisitorFactoryDiffblueTest {
  ...
  void
    ...
    ClassPoolVisitor actualCreateClassPoolVisitorResult =
        keepClassSpecificationVisitorFactory.createClassPoolVisitor(
            keepClassSpecification, null, null, null, new KotlinAnnotationCounter());
    actualCreateClassPoolVisitorResult.visitClassPool(new ClassPool());
  ...
  void
    ...
    ClassSpecification condition =
        new ClassSpecification(
            ...
            "Extends Annotation Type",
            "Extends Class Name");
    condition.addField(new MemberSpecification(1, 1, "Annotation Type", "Name", "Descriptor"));
    KeepClassSpecification keepClassSpecification =
        new KeepClassSpecification(
            true,
            true,
  ...
  void
    ...
    ClassSpecification condition =
        new ClassSpecification(
            ...
            "Extends Annotation Type",
            "Extends Class Name");
    condition.addMethod(new MemberSpecification(1, 1, "Annotation Type", "Name", "Descriptor"));
    condition.addField(new MemberSpecification(1, 1, "Annotation Type", "Name", "Descriptor"));
    KeepClassSpecification keepClassSpecification =
        new KeepClassSpecification(
            true,
  ...
  void
    ...
    ClassSpecification condition =
        new ClassSpecification(
            ...
            "Extends Annotation Type",
            "Extends Class Name");
    condition.addField(new MemberSpecification(0, 1, "Annotation Type", "Name", "Descriptor"));
    KeepClassSpecification keepClassSpecification =
        new KeepClassSpecification(
            true,
            true,
