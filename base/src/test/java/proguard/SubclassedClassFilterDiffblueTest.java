...
class SubclassedClassFilterDiffblueTest {
  ...
  @MethodsUnderTest({"void proguard.SubclassedClassFilter.visitAnyClass(proguard.classfile.Clazz)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void proguard.SubclassedClassFilter.visitProgramClass(proguard.classfile.ProgramClass)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void proguard.SubclassedClassFilter.visitLibraryClass(proguard.classfile.LibraryClass)"})
